...
const guideDefinitions = {
  male: {
    ...
    marks: [
      ...
      { key: "sleeve", section: "Upper body", label: "Sleeve length", instruction: "Measure from the shoulder point where the sleeve seam starts down to the wrist.", view: "front", type: "diagonal", x1: 76, y1: 82, x2: 47, y2: 152 },
      ...
      { key: "knee", section: "Trouser", label: "Knee", instruction: "Wrap around the knee joint.", view: "front", type: "horizontal", x1: 88, x2: 110, y: 214 },
  ...
  female: {
    ...
    marks: [
      ...
      { key: "knee", section: "Lower body", label: "Knee", instruction: "Wrap around the knee joint.", view: "front", type: "horizontal", x1: 88, x2: 110, y: 214 },
