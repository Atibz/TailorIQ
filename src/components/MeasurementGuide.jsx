...
const guideDefinitions = {
  male: {
    ...
    marks: [
      ...
      { key: "stomach", section: "Upper body", label: "Stomach", instruction: "Wrap around the belly line, usually slightly above the trouser waist.", view: "front", type: "horizontal", x1: 86, x2: 144, y: 120 },
      ...
      { key: "armhole", section: "Upper body", label: "Armhole", instruction: "Measure around the arm opening from shoulder, underarm, and back up.", view: "front", type: "curve", path: "M80 82 C64 94 64 120 80 136", cx: 74, cy: 109 },
      { key: "sleeve", section: "Upper body", label: "Sleeve length", instruction: "Measure from the shoulder point where the sleeve seam starts down to the wrist.", view: "front", type: "diagonal", x1: 76, y1: 82, x2: 47, y2: 146 },
      ...
      { key: "wrist", section: "Upper body", label: "Cuff / wrist", instruction: "Wrap around the wrist or desired cuff opening.", view: "front", type: "horizontal", x1: 37, x2: 58, y: 142 },
      { key: "topLength", section: "Upper body", label: "Top length", instruction: "Measure from the shoulder near the neck down to the hip or seat line.", view: "front", type: "vertical", x: 164, y1: 62, y2: 166 },
      ...
      { key: "trouserLength", section: "Trouser", label: "Outseam", instruction: "Measure from the trouser waistband down the outside leg to the ankle.", view: "front", type: "vertical", x: 174, y1: 142, y2: 242 },
      { key: "inseam", section: "Trouser", label: "Inseam", instruction: "Measure from crotch down the inside leg to the ankle.", view: "front", type: "vertical", x: 115, y1: 174, y2: 242 },
      ...
      { key: "thigh", section: "Trouser", label: "Thigh", instruction: "Wrap around the fullest part of the upper thigh.", view: "front", type: "horizontal", x1: 86, x2: 116, y: 182 },
      { key: "knee", section: "Trouser", label: "Knee", instruction: "Wrap around the knee joint.", view: "front", type: "horizontal", x1: 84, x2: 106, y: 204 },
  ...
  female: {
    ...
    marks: [
      ...
      { key: "underbust", section: "Upper body", label: "Underbust", instruction: "Wrap around the ribcage directly below the bust.", view: "front", type: "horizontal", x1: 84, x2: 146, y: 112 },
      { key: "waist", section: "Upper body", label: "Waist", instruction: "Wrap around the natural waist, the narrowest part of the torso.", view: "front", type: "horizontal", x1: 88, x2: 142, y: 132 },
      ...
      { key: "bustPoint", section: "Upper body", label: "Bust point", instruction: "Measure from shoulder near the neck down to the bust apex.", view: "front", type: "vertical", x: 101, y1: 62, y2: 98 },
      { key: "bustSpan", section: "Upper body", label: "Bust span", instruction: "Measure from one bust apex to the other.", view: "front", type: "horizontal", x1: 96, x2: 134, y: 98 },
      { key: "frontLength", section: "Upper body", label: "Front bodice length", instruction: "Measure from shoulder through the bust point down to the waist.", view: "front", type: "vertical", x: 160, y1: 62, y2: 132 },
      { key: "backLength", section: "Upper body", label: "Back bodice length", instruction: "Measure from back neck down to the natural waist.", view: "back", type: "vertical", x: 320, y1: 60, y2: 132 },
      { key: "armhole", section: "Upper body", label: "Armhole", instruction: "Measure around the arm opening from shoulder, underarm, and back up.", view: "front", type: "curve", path: "M80 82 C64 94 64 120 80 136", cx: 74, cy: 109 },
      { key: "sleeve", section: "Upper body", label: "Sleeve length", instruction: "Measure from the shoulder point where the sleeve seam starts down to the wrist.", view: "front", type: "diagonal", x1: 76, y1: 82, x2: 47, y2: 146 },
      { key: "bicep", section: "Upper body", label: "Round sleeve", instruction: "Wrap around the fullest part of the upper arm.", view: "front", type: "horizontal", x1: 45, x2: 70, y: 112 },
      { key: "topLength", section: "Upper body", label: "Blouse/top length", instruction: "Measure from shoulder down to the high hip line.", view: "front", type: "vertical", x: 172, y1: 62, y2: 154 },
      { key: "waistLower", section: "Lower body", label: "Waist band", instruction: "Wrap around the chosen skirt, trouser, or gown waistband line, usually just below the navel.", view: "front", type: "horizontal", x1: 86, x2: 144, y: 140 },
      { key: "highHip", section: "Lower body", label: "High hip", instruction: "Wrap around the upper hip right below the waistband.", view: "front", type: "horizontal", x1: 82, x2: 148, y: 150 },
      { key: "hip", section: "Lower body", label: "Full hip", instruction: "Wrap around the broadest point of the hip just below the high hip.", view: "front", type: "horizontal", x1: 76, x2: 154, y: 168 },
      { key: "waistToHip", section: "Lower body", label: "Waist to hip", instruction: "Measure vertically from natural waist down to the high hip line.", view: "front", type: "vertical", x: 98, y1: 132, y2: 150 },
      { key: "lowerLength", section: "Lower body", label: "Skirt/trouser length", instruction: "Measure from the natural waist down to the ankle.", view: "front", type: "vertical", x: 174, y1: 132, y2: 242 },
      { key: "rise", section: "Lower body", label: "Rise", instruction: "For trousers, measure from natural waist down to crotch depth.", view: "front", type: "vertical", x: 112, y1: 132, y2: 178 },
      { key: "inseam", section: "Lower body", label: "Inseam", instruction: "For trousers, measure from crotch down the inside leg to the ankle.", view: "front", type: "vertical", x: 118, y1: 178, y2: 242 },
      { key: "thigh", section: "Lower body", label: "Thigh", instruction: "Wrap around the fullest part of the upper thigh.", view: "front", type: "horizontal", x1: 86, x2: 116, y: 184 },
      { key: "knee", section: "Lower body", label: "Knee", instruction: "Wrap around the knee joint.", view: "front", type: "horizontal", x1: 84, x2: 106, y: 204 },
...
const strokeColor = "#ff9f00";
const markerFill = "#111111";
...
function MeasurementMark({ mark, index }) {
  ...
  return (
    <g>
      ...
      {mark.type === "curve" && (
        <path d={mark.path} fill="none" stroke={strokeColor} strokeWidth="2.5" strokeLinecap="round" />
      )}
      {mark.type === "circle" && (
        <circle cx={mark.cx} cy={mark.cy} r={mark.r} fill="none" stroke={strokeColor} strokeWidth="2.5" />
      )}

      <circle cx={point.x} cy={point.y} r="8" fill={markerFill} stroke="#f1f1f1" strokeWidth="2" />
      <text x={point.x} y={point.y + 3.5} textAnchor="middle" fill="#f1f1f1" fontSize="9" fontWeight="800">
        {index + 1}
      </text>
    </g>
  );
...
function BodyFigure({ profileId, view, marks }) {
  ...
  return (
    <g transform={`translate(${offset} 0)`}>
      <text x="115" y="22" textAnchor="middle" fill="#f1f1f1" fontSize="13" fontWeight="800">
...
function MeasurementDiagram({ profileId, marks }) {
  ...
  return (
    <svg className="h-[32rem] w-full" viewBox="0 0 460 290" role="img" aria-label="Measurement placement diagram">
      <rect width="460" height="290" rx="14" fill="#000004" />
